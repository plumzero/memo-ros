...
#2  0x00007f9e0401bbe7 in __assert_fail_base (fmt=<optimized out>, 
    ...
    file=file@entry=0x4fdbd8 "/home/user/Public/rosdev/include/boost/smart_ptr/shared_ptr.hpp", 
    line=line@entry=783, 
...
#3  0x00007f9e0401bc92 in __GI___assert_fail (assertion=0x4fdc19 "px != 0", 
    file=0x4fdbd8 "/home/user/Public/rosdev/include/boost/smart_ptr/shared_ptr.hpp", line=783, 
...
#4  0x00000000004b4721 in boost::shared_ptr<rosbag::EncryptorBase>::operator-> (this=0x7ffcf4b07d50)
    at /home/user/Public/rosdev/include/boost/smart_ptr/shared_ptr.hpp:783
#5  0x00000000004aa884 in rosbag::Bag::setEncryptorPlugin (this=0x7ffcf4b07ae0, 
    plugin_name="rosbag/NoEncryptor", plugin_param="")
    at /home/user/Public/rosdev/include/ros_comm/tools/rosbag_storage/src/bag.cpp:225
#6  0x00000000004a9cad in rosbag::Bag::init (this=0x7ffcf4b07ae0)
    at /home/user/Public/rosdev/include/ros_comm/tools/rosbag_storage/src/bag.cpp:103
#7  0x00000000004a9467 in rosbag::Bag::Bag (this=0x7ffcf4b07ae0)
    at /home/user/Public/rosdev/include/ros_comm/tools/rosbag_storage/src/bag.cpp:60
#8  0x0000000000491416 in main (argc=4, argv=0x7ffcf4b08678)
    at /home/user/Public/rosdev/tests/bag_info.cpp:43
```
