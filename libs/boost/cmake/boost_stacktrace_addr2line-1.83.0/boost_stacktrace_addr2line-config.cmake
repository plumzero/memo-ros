...
if(EXISTS "/tmp/boost/lib/cmake")
  get_filename_component(_BOOST_CMAKEDIR_ORIGINAL "/tmp/boost/lib/cmake" REALPATH)
  if(_BOOST_CMAKEDIR STREQUAL _BOOST_CMAKEDIR_ORIGINAL)
    set(_BOOST_CMAKEDIR "/tmp/boost/lib/cmake")
  endif()
...
foreach(dep_boost_stacktrace_addr2line IN LISTS _BOOST_STACKTRACE_ADDR2LINE_DEPS)
  ...
  find_package(boost_${dep_boost_stacktrace_addr2line} 1.83.0 EXACT CONFIG ${_BOOST_REQUIRED} ${_BOOST_QUIET} HINTS ${_BOOST_CMAKEDIR})
